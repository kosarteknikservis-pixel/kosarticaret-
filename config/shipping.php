...
return [
    ...
    'shipping_methods' => [
        ['id' => 'standart', 'name' => 'Standart Kargo', 'desc' => '1000 TL üzeri ücretsiz', 'eta' => '2-4 iş günü'],
        ['id' => 'hizli', 'name' => 'Hızlı Kargo', 'desc' => 'Öncelikli sevkiyat', 'eta' => '1-2 iş günü'],
    ],
    'payment_methods' => [
        ['id' => 'kredi_karti', 'name' => 'Kredi / Banka Kartı', 'desc' => '3D Secure (demo)'],
