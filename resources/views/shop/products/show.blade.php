...
@section('content')
    ...
    <div class="grid lg:grid-cols-2 shop-pdp shop-reveal-group">
        @php
            $thumbs = collect();
            if ($product->imageUrl()) {
            ...
            <button type="button"
                ...
                @if($thumbs->isNotEmpty())
                    <span class="shop-pdp-gallery__figure">
                        <img src="{{ $thumbs->first()['url'] }}" alt="{{ $thumbs->first()['alt'] }}" class="shop-pdp-gallery__img" id="pdp-main-img" decoding="async">
                    </span>
                @else
        ...
        <div class="shop-pdp-info lg:pt-1">
    ...
    <section class="mt-14">
        ...
        <div id="pdp-panel-description" class="pdp-panel mt-6 shop-rich-content">
            <x-shop.rich-content :content="$product->description" />
        </div>

        @if(!empty($product->specs))
            <div id="pdp-panel-specs" class="pdp-panel mt-6 hidden">
